...
procedure showCtrl(ctrl: TControl);
begin
  if (mpst_code = '0579033000') or (mpst_code = '2016060060') then // 0579033000 - 정송
  begin
...
begin
  ...
  begin
    ...
    begin
      // 본점 사업장 조회
      ashSQL := 'SELECT "일괄제출" hr_b_name, hr_b_code, hr_b_head_yn, hr_b_half_yearly_yn'
              + ' FROM hr_branch'
